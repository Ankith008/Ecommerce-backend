...
const handleRefreshToken = async (req, res) => {
  try {
    ...
    try {
      jwt.verify(refreshToken, process.env.USER_REFRESH_TOKEN_SECRET);
      roles = "User";
      model = User;
      ...
      try {
        jwt.verify(refreshToken, process.env.COMPANY_REFRESH_TOKEN_SECRET);
        roles = "Company";
        model = Company;
        ...
        try {
          jwt.verify(refreshToken, process.env.DELIVERY_REFRESH_TOKEN_SECRET);
          roles = "Delivery boy";
          model = Delivery;
